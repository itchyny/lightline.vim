...
let s:p.normal.left = [ [ s:blue, s:white ], [ s:white, s:blue ] ]
...
let s:p.insert.left =  [ [ s:green, s:white ], [ s:white, s:green ] ]
let s:p.replace.left = [ [ s:red, s:white ], [ s:white, s:red ] ]
let s:p.visual.left = [ [ s:purple, s:white ], [ s:white, s:purple ] ]
